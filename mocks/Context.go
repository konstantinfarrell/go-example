...
// Attachment provides a mock function with given fields: _a0, name
func (_m *Context) Attachment(_a0 string, name string) error {
...
// Inline provides a mock function with given fields: _a0, name
func (_m *Context) Inline(_a0 string, name string) error {
	ret := _m.Called(_a0, name)
